...
@injectIntl
export default class RuleServiceConfigModal extends Component {
  constructor() {
    super();
    this.state = {
      checkValue: {},
  ...
  render() {
    const {modalVisible, onCancelModal, handleCheckValue, warning: {warningService_list_list, warningServiceHasMore, serviceConfigCheckedValue}, loading, intl: {formatMessage}} = this.props;
    return (
      <Modal
        ...
        footer={
          <div style={{textAlign: 'center'}}>
            <Button type="primary" onClick={() => {
              ...
              this.props.dispatch({
                type: 'warning/ruleServiceConfigCheckedValue',
