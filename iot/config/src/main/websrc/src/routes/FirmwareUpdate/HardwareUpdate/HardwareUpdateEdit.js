...
@injectIntl
@Form.create()
export default class HardwareUpdateEdit extends Component {
  constructor() {
    super();
    this.state = {
      times:['times1'],
        ...
        >
          <div className='mrgTB30' style={{width: 1200}}>
            ...
            <div style={{textAlign: 'center'}}>
                <Button loading={loading} type={'primary'} onClick={this.updateUpdateDuty}>{formatMessage(basicMessages.confirm)}</Button>
              </div>
              ...
              <HardwareUpdateAddConfigTime
                ...
                //ruleConfig={getUpgradeTimeConfig&&getUpgradeTimeConfig.ruleConfig}
              />
