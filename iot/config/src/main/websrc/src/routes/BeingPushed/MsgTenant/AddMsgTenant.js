...
@connect(({msgTenant, loading}) => ({
  msgTenant,
  loading: loading.effects['msgTenant/fetch_addTenantConfig_action'],
}))
@injectIntl
@Form.create()
export default class AddMsgTenant extends Component {
  constructor() {
    super();
    this.state = {
      checkedValue:[],
  ...
  handleSubmit = (e) => {
    ...
    form.validateFieldsAndScroll((err, formValues) => {
      if (!err) {
        ...
        this.props.dispatch({
          type: 'msgTenant/fetch_addTenantConfig_action',
          payload: {
              ...
              >
                {
                  getFieldDecorator('tenantName', {
                    ...
                    initialValue:item&&item.tenantName
                  })(
                    <Input disabled/>
                  )
                }
                            ...
                            >
                              {
                                getFieldDecorator('appRemind_email1', {
                                  ...
                                  //initialValue:app[0].remind_mail[1]
                                })(
                                  <Input/>
                                )
                              }
                            ...
                            >
                              {
                                getFieldDecorator('appRemind_email2', {
                                  ...
                                  //initialValue:app[0].remind_mail[2]
                                })(
                                  <Input/>
                                )
                              }
                            ...
                            <Row>
                              ...
                              <Col span={10}>
                                <div style={{lineHeight:'39px'}}>
                                  {formatMessage(messages.msg_strip)}
                            ...
                            >
                              {
                                getFieldDecorator('msgRemind_phone2', {
                                  ...
                                  //initialValue:msg[0].remind_phone[2]
                                })(
                                  <Input/>
                                )
                              }
                            ...
                            >
                              {
                                getFieldDecorator('msgRemind_email2', {
                                  ...
                                  //initialValue:msg[0].remind_mail[2]
                                })(
                                  <Input/>
                                )
                              }
                            ...
                            >
                              {
                                getFieldDecorator('emailRemind_phone1', {
                                  ...
                                  //initialValue:email[0].remind_phone[1]
                                })(
                                  <Input/>
                                )
                              }
                            ...
                            >
                              {
                                getFieldDecorator('emailRemind_phone2', {
                                  ...
                                  //initialValue:email[0].remind_phone[2]
                                })(
                                  <Input/>
                                )
                              }
                            ...
                            >
                              {
                                getFieldDecorator('emailRemind_email1', {
                                  ...
                                  //initialValue:email[0].remind_mail[1]
                                })(
                                  <Input/>
                                )
                              }
