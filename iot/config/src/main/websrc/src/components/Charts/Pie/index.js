        ...
        <ReactFitText maxFontSize={25}>
          <div className={styles.chart}>
            ...
            >
              ...
              >
              {
                showLabel && <Label offset={12} content={['percent*x',(percent,x)=>{
                  return {percent:percent,x:x}
                }]} formatter={(val, item) => {
                  const percent = `${(isNaN(val.percent) ? 0 : val.percent * 100).toFixed(2)}%`;
                  return val.x+ ': ' + percent;}} />
              }
