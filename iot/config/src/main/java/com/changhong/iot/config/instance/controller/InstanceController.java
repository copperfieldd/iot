...
public class InstanceController {
    ...
    public ServerResponse instance(@PathVariable String node, @RequestParam String serviceId) {

        ServiceInstances instances = instanceService.find(serviceId);
        ...
        String result = null;
        try {
            result = doGet("http://"+host + ":" + port + "/" + node);
    ...
    public static String doGet(String url) throws ByteException {
