...
/** UtilFuns is a JavaBean.  */
 public class UtilFuns {
    ...
    public static final Logger LOGGER = LoggerFactory.getLogger(UtilFuns.class);
 ...
 */
  ...
  public static String convertNull(Object o)
  {
    try{
      ...
      if(strvalue == null || "null".equals(strvalue) || strvalue.length()==0){
        return "";
      }else{
        return strvalue.trim();
      }
  ...
  */
  ...
  public static String convertCStr(Object o)
  {
    ...
    try{
      ...
      LOGGER.info("ConvertCStr:" + e.toString());
      return "";
    }
  }
   ...
   */
    public String urlDecoder(String s)
    {
        ...
        catch(Exception e)
        {
            ...
            LOGGER.info("URL Encoder :" + e.toString());
            s1 = "";
        }
        return s1;
    }
    ...
    if ( strvalue.equals( "null" ) ) {
      ...
      if(sFlag>=Flag){
        if ( intStrvalue > Flag ) {
          ...
          StringBuffer buf = new StringBuffer(strvalue1);
          for (int i = 0; i < iPassLen; ++i) {
              buf.append("*");
          }
          strvalue = buf.append(strvalue2).toString();
      }
      //System.out.print( "strvalue:" + strvalue );
      return strvalue;
    }
    ...
    try {
      ...
      if ( s.equals("null")){
		...
		if ( ints > iEndPos) {
          ...
          StringBuffer buf = new StringBuffer(sCenterStr);
          for (int i = 0; i < iPatternLen; ++i) {
              buf.append(sPattern);
          }
        return buf.append(sStartStr).append(sEndStr).toString();
      }
    }
    catch (Exception e) {
       LOGGER.info("e:" + e);
