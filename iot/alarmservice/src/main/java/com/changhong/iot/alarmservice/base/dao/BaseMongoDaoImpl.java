...
public abstract class BaseMongoDaoImpl<T> implements BaseMongoDao<T> {
	...
	public PageModel<T> pageByProps(int pageNo, int pageSize, String[] params, Object[] values, String order) {
		...
		// 封装结果数据
		page.setValue(mgt.find(query, getEntityClass()));
...
//	@Override
//	public T findByIdAndTenantId(Serializable id, String tenantId) {
//
//		Query query = createQuery(
//				new String[] {ConfigField.S_MONGO_ID, ConfigField.S_TENANT_ID, ConfigField.I_DELETE_FLAG},
//				new Object[] {id, tenantId, ConfigValue.NOT_DELETE}, null);
//
//		return mgt.findOne(query, getEntityClass());
//	}
//
//	@Override
//	public boolean deleteByIdAndTenantId(Serializable id, String tenantId, boolean flag) {
//
//		WriteResult result = null;
//
//		Query query = createQuery(
//				new String[] { ConfigField.S_MONGO_ID, ConfigField.S_TENANT_ID},
//				new Object[] { id, tenantId}, null);
//
...
//
//		if (flag) {
//			result = this.mgt.remove(query, getEntityClass());
//		} else {
//			result = this.mgt.updateFirst(query, update, getEntityClass());
//		}
//
//		return result != null ? result.wasAcknowledged() : false;
//	}
	...
	@Override
	public PageModel<T> pageLikeAndProps(int pageNo, int pageSize, String[] likeKeys, Object[] likeValues, String[] keys, Object[] values, String order) {
		// 创建分页模型对象
		PageModel<T> page = new PageModel<>(pageNo, pageSize);
	...
	@Override
	public PageModel<T> pageByPropAndLike(int pageNo, int pageSize, String param, Object value, String likeParam, Object likeValue) {
		// 创建分页模型对象
		PageModel<T> page = new PageModel<>(pageNo, pageSize);

		// 查询总记录数
		int count = countLikeAndCondition(new String[] {likeParam}, new Object[] {likeValue},
				new String[] {param}, new Object[] {value});
		page.setTotalCount(count);

		// 查询数据列表
		Query query = createLikeAndQuery(new String[] {likeParam}, new Object[] {likeValue},
			new String[] {param}, new Object[] {value}, null);
