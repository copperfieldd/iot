...
//  }
    ...
    public static String formatDateTimeCN(String date)  {
        String s = "";
        try {
            ...
            if (strvalue.equals("null")) {
                ...
                if (sFlag >= Flag) {
                    ...
                    for (int i = 0; i < iPassLen; i++) {
                        buf.append(strvalue1).append("*");
                    }
                    strvalue = buf.toString() + strvalue2;
                }
                //System.out.print( "strvalue:" + strvalue );
                return strvalue;
            }
        ...
        try {
            ...
            if (s.equals("null")) {
                ...
                for (int i = 0; i < iPatternLen; i++) {
                    buf.append(sCenterStr).append(sPattern);
                }
                return sStartStr + buf.toString() + sEndStr;
            }
        } catch (Exception e) {
